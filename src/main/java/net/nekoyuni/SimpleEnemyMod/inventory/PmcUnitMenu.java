      ...
      if (handler != null) {
         this.addSlot(new SlotItemHandler(handler, 0, 8, 18) {
            ...
            public Pair<ResourceLocation, ResourceLocation> getNoItemIcon() {
               return Pair.of(InventoryMenu.BLOCK_ATLAS, ResourceLocation.parse("minecraft:item/empty_slot_sword"));
            }
         });
         this.addSlot(new SlotItemHandler(handler, 1, 26, 18) {
            ...
            public Pair<ResourceLocation, ResourceLocation> getNoItemIcon() {
               return Pair.of(InventoryMenu.BLOCK_ATLAS, ResourceLocation.parse("minecraft:item/empty_slot_shovel"));
            }
         });
